    ...
    t.fn.noUiSlider = function(e) {
        ...
        function d(n, e) {
            ...
            t.each(r, function(t, a) {
                if (a.r && !n[t] && 0 !== n[t] || (n[t] || 0 === n[t]) && !a.t(n[t], n, t))
                    throw console && console.log && console.group && (console.group("Invalid noUiSlider initialisation:"), console.log("Option:	", t), console.log("Value:	", n[t]), console.log("Slider:	", e[0]), console.groupEnd()), new RangeError("noUiSlider")
            })
        }
        function u(t, n) {
        ...
        function U(e, i) {
            return e === n ? w.call(this) : (i = i === !0 ? {
                trigger: !0
            } : i || {}, t.isArray(e) || (e = [e]), this.each(function(o, r) {
                r = t(r),
                t.each(t(this).data("handles"), function(o, s) {
                    if (null !== e[o] && e[o] !== n) {
                        ...
                        u || (l = s.data("store").val(), d = k.is(f, s[0].gPct(s.data("nui").style)), l !== d && s.data("store").val(c(d, r)))
                    }
                })
            }))
        }
...
var setShiftDown = function(event) {
    if (event.keyCode === 16 || event.charCode === 16) {
        //for future reference, alt key is 18
        shiftDown = true;
    }
};
...
function Demo(settings) {
    ...
    this.addUIElement = function(prop) {
        ...
        } else // self.update(prop);
        if (ui[prop].type == "userInputString") {
            var inputBoxHTML = "";
            if (ui[prop].prepend) {
        ...
        if (ui[prop].type == "userInputTextarea") {
